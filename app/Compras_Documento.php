...
class Compras_Documento  {
		...
		$arr['Emisor']['nombre'] = "Nombre_del_emisor"; //CAMBIAR NOMBRE_EMISOR
        $arr['Emisor']['rfc'] = "RFC"; //CAMBIAR RFC
		$rfc_emisor = "RFC"; //CAMBIAR RFC
        $arr['Emisor']['Regimen'] = "REGIMEN_FISCAL"; //CAMBIAR REFIMEN_FISCAL
        
		
		
		$arr['noCertificado'] = "00000000000000000000"; //CAMBIAR CERTIFICADO
		
		
		$arr['Emisor']['calle'] = "CALLE"; //CAMBIAR CALLE
        $arr['Emisor']['noExterior'] = "0"; //CAMBIAR NÚMERO EXTERIOR
        $arr['Emisor']['noInterior'] = "0"; //CAMBIAR NÚMERO INTERIOR
		$arr['Emisor']['colonia'] = "COLONIA"; //CAMBIAR COLONIA
        $arr['Emisor']['localidad'] = "LOCALIDAD"; //CAMBIAR LOCALIDAD
        $arr['Emisor']['municipio'] = "MUNICIPIO"; //CAMBIAR MUNICIPIO
        $arr['Emisor']['estado'] = "ESTADO"; //CAMBIAR ESTADO
        $arr['Emisor']['pais'] = "PAIS"; //CAMBIAR PAIS
        $arr['Emisor']['codigoPostal'] = "CODIGO_POSTAL"; //CAMBIAR CODIGO POSTAL
		
        $arr['Emisor']['ExpedidoEn']['calle'] = "CALLE"; //CAMBIAR_CALLE
        $arr['Emisor']['ExpedidoEn']['noExterior'] = "0"; //CAMBIAR_NUMERO_EXTERIOR
        $arr['Emisor']['ExpedidoEn']['noInterior'] = "0"; //CAMBIAR_NUMERO_INTERIOR
		$arr['Emisor']['ExpedidoEn']['colonia'] = "COLONIA"; //CAMBIAR_COLONIA
        $arr['Emisor']['ExpedidoEn']['localidad'] = "LOCALIDAD"; //CAMBIAR_LOCALIDAD
        $arr['Emisor']['ExpedidoEn']['municipio'] = "MUNICIPIO"; //CAMBIAR_MUNICIPIO
        $arr['Emisor']['ExpedidoEn']['estado'] = "ESTADO"; //CAMBIAR_ESTADO
        $arr['Emisor']['ExpedidoEn']['pais'] = "PAIS"; //CAMBIAR PAIS
        $arr['Emisor']['ExpedidoEn']['codigoPostal'] = "CODIGO_POSTAL"; //CAMBIAR_CODIGO_POSTAL
		$arr['LugarExpedicion']= "LUGAR_EXPEDICION"; //CAMBIAR_LUGAR_EXPEDICION
...
$pkeyid = openssl_get_privatekey(Storage::disk('local')->get('compras/tu_llave_en_pem.key.pem')); //CAMBIAR POR LLAVE REAL EN storage/app/compras
...
$datos = Storage::disk('local')->get('compras/tu_certificado_en_pem.cer.pem');//CAMBIAR POR CERTIFICADO REAL EN storage/app/compras
