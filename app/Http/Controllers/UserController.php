	...
	public function update(ProfileRequest $request)
	{
		...
		$usuario = [];
		 ...
		 if($request -> get('conektaTokenId') != '')
		   ...
		   Conekta::setApiKey("key_algo"); //Llave privada de Conekta
...
try {
     ...
     $res = $client->otorgarAccesoContribuyente(
          array(
                'user' => 'Usuario', //Cambiar por Usuario RFacil
                'userPassword' => 'Password', //Cambiar por Password de RFacil
                'contribuyenteRFC' => $request->get('rfc'),
                'contribuyenteRazonSocial' => $request->get('regimen')
          )
     );
} catch ( Exception $e ) {
