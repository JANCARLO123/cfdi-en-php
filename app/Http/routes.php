...
Route::post('loans/withdraw', 'LoanController@withdraw');
Route::get('loans/backup', 'LoanController@backup');
Route::get('loans/report', 'LoanController@report');
Route::resource('loans', 'LoanController');

Route::post('savings/withdraw', 'SavingController@withdraw');
Route::get('savings/backup', 'SavingController@backup');
Route::get('savings/report', 'SavingController@report');
