...
/*  Gran parte de este código fue armado a partir de aquel brindado por La Corona http://www.lacorona.com.mx/fortiz/sat/codigo.php */
...
try {
     ...
     $res = $client->TimbraEnviaCFDIxp(
          array(
                'user' => 'usuario', //Ponemos el usuario real de rfacil
                'userPassword' => 'pwd', //Ponemos la contraseña real de rfacil
