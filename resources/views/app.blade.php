	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{ url('/') }}">Tu_dominio</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					@else
	                  ...
	                  <li class="dropdown">
					   ...
					   <li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Préstamos<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="{{ url('loans/create') }}">Crear préstamo</a></li>
								<li><a href="{{ url('loans/show') }}">Capturar un Pago</a></li>
								<li><a href="{{ url('loans/report') }}">Reporte de los préstamos que he dado</a></li>
							</ul>							
						</li>
					   
					   <li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Ahorros<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="{{ url('savings/create') }}">Crear ahorro</a></li>
								<li><a href="{{ url('savings/show') }}">Capturar un abono</a></li>
								<li><a href="{{ url('savings/report') }}">Reporte de los ahorros que administro</a></li>
							</ul>							
						</li>
