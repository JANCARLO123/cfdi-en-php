	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">Aviso Libre</div>
				<div class="panel-body">

@include('errors.list')

{!! Form::open(['url' => 'reminders/storeOpen']) !!}

{!! Form::hidden('tipo', '4') !!}

<h3>Envío</h3>
<input type="hidden" name="c_sms" id="c_sms" value="1"/>
...
<div id="cobro">
<div class="form-group">
{!! Form::label('descripcion','Recordatorio') !!}
{!! Form::textarea('descripcion',null,['class' => 'form-control','placeholder' => 'Escribe el recordatorio que deseas crear']) !!}
</div>
